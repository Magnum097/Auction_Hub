...
<button style="font-size:14pt; background-color:#90D5EC; margin-bottom:1em;" onclick="window.location.href='Success.jsp';">Back</button>
    	...
    	<tr>	
			...
			<%ResultSet resultSet1 = statement.executeQuery("select * from question q");%>
					...
					<%while(resultSet1.next()){
						//looking for questions based on the keyword
						String question = resultSet1.getString("q.questionText");
